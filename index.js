...
Do the following:   
   ...
   4. Console log the value of the 1st variablew

   HINT: no function required
*/
const firstThing = "Dust";
const secondThing = "gold";
...
function hungryDog(weight, age) {
  if (age < 1 && age > (7 / 12)) {
    return .04 * weight;
  } else if (age < 1 && age > (4 / 12)) {
    return .05 * weight;
  } else if (age < 1 && age > (2 / 12)) {
    return .1 * weight;
  }
  if (age >= 1 && weight <= 5) {
    return .05 * weight;
